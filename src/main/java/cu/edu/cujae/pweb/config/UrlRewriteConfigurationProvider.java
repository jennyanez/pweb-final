...
public class UrlRewriteConfigurationProvider extends HttpConfigurationProvider{
    ...
    public Configuration getConfiguration(ServletContext context) {
        return ConfigurationBuilder.begin()
                ...
                .addRule(Join.path("/clients").to("/pages/clients/client-list.jsf"))
                ...
                .addRule(Join.path("/breaches").to("/pages/clients/breach-list.jsf"))
                .addRule(Join.path("/sanctions").to("/pages/clients/sanction-list.jsf"))
                ;
