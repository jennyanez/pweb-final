...
public class UserServiceImpl implements UserService{
	...
	public List<XUserDto> getUsers() {
		...
		List<XRoleDto> asesorRole = roleService.getRolesByName("asesor");
		...
		users.add(new XUserDto(UUID.randomUUID().toString().replaceAll("-", "").substring(0, 9), "rcoas", "Ronaldo Coas Saldivar", "2w2ee22ww2", "rcoas@email.com", "36985214785", adminRole, false));
		...
		users.add(new XUserDto(UUID.randomUUID().toString().replaceAll("-", "").substring(0, 9), "fromero", "Facundo Romero Ramen", "3www4ewwewe", "fromero@email.com", "85669854125", asesorRole, false));
		users.add(new XUserDto(UUID.randomUUID().toString().replaceAll("-", "").substring(0, 9), "ptobal", "P�nfilo Tobal Madrid", "343sd3443wwe", "ptobal@email.com", "25147856325", asesorRole, false));
		users.add(new XUserDto(UUID.randomUUID().toString().replaceAll("-", "").substring(0, 9), "imeri�o", "Ian Meri�o Sandival", "4weer4ewere", "imeri�o@email.com", "21254789632", allRoles, false));
		users.add(new XUserDto(UUID.randomUUID().toString().replaceAll("-", "").substring(0, 9), "jpacheco", "Javier Pacheco Losada", "8555weweww", "jpacheco@email.com", "96582365147", allRoles, false));
