...
public class ManageWebUserBean {
    
    private WebUserDto userDto;
    private WebUserDto selectedUser;
    private List<WebUserDto> users;
    ...
    public void openNew() {
        this.selectedUser = new WebUserDto();
        this.selectedRoles = null;
    }
    
    //Se ejecuta al dar clic en el button con el lapicito
    public void openForEdit() {
        List<WebRoleDto> roles = this.selectedUser.getRoles();
    ...
    public void saveUser() {
        if (this.selectedUser.getId() == null) {
            ...
            List<WebRoleDto> rolesToAdd = new ArrayList<WebRoleDto>();
    ...
    public WebUserDto getUserDto() {
        return userDto;
    }

    public void setUserDto(WebUserDto userDto) {
        this.userDto = userDto;
    }

    public WebUserDto getSelectedUser() {
        return selectedUser;
    }

    public void setSelectedUser(WebUserDto selectedUser) {
    ...
    public void setUsers(List<WebUserDto> users) {
        this.users = users;
    }
